    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black flex items-center justify-center px-4">
            <div className="text-center max-w-md mx-auto">
                <div className="mb-8">
                    <svg className="w-16 h-16 md:w-20 md:h-20 mx-auto mb-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                ...
                <h2 className="text-xl md:text-2xl text-white/80 mb-8">
                    Hello {data.state?.user || 'User'}
                </h2>
                
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 md:p-8">
                    <p className="text-white/70 text-sm md:text-base mb-6">
                        You have successfully signed up and logged in to Netflix!
                    </p>
                    
                    <div className="space-y-4">
                        <button className="w-full bg-[#E50914] hover:bg-red-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-200">
                            Start Watching
                        </button>
                        
                        <button className="w-full bg-white/20 hover:bg-white/30 text-white font-semibold py-3 px-6 rounded-lg transition duration-200">
                ...
                <p className="text-white/50 text-xs md:text-sm mt-6">
                    Enjoy unlimited streaming on all your devices
                </p>
            </div>
        </div>
    )
